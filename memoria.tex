...
\begin{figure}[H]
  \centering
  \includegraphics[width=9cm, keepaspectratio]{MemoriaTFG-JulianPerez/img/Threejs.png}
...
\begin{figure}[H]
  \centering
  \begin{minipage}[b]{0.4\textwidth}
 \includegraphics[width=8cm]{MemoriaTFG-JulianPerez/img/House.png}
  \caption{Casa}\label{single}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
  \includegraphics[width=8cm]{MemoriaTFG-JulianPerez/img/Captura de pantalla 2021-06-13 a las 13.56.04.png}
...
\begin{figure}[H]
  \centering
  \begin{minipage}[b]{0.4\textwidth}
 \includegraphics[width=8cm]{MemoriaTFG-JulianPerez/img/Ovnis.png}
  \caption{Ovnis}\label{single}
  \end{minipage}
  \hfill
  \begin{minipage}[b]{0.4\textwidth}
  \includegraphics[width=8cm, keepaspectratio]{MemoriaTFG-JulianPerez/img/Captura de pantalla 2021-06-13 a las 12.52.14.png}
