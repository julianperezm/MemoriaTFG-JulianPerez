...
\label{sec:GitHub}
GitHub~\cite{jetbrains} es una platafroma de alamacenamiento y administración  de software, Este sistema es basado en el control de control de versiones \footnote{\url{https://es.wikipedia.org/wiki/TeX}} y en Git \footnote{\url{https://es.wikipedia.org/wiki/TeX}}.
